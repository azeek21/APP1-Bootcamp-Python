...
class Player(object):
    ...
    def __init__(self, name: str = "DefPlayer", candies: int = 0):
        self.candies = 0
        self.name = name
        self.behaviour = None
    ...
    def reset(self):
        self.behaviour = Behaviours.Cooperator if self.original_behaviour != Behaviours.Cheater else Behaviours.Cheater
